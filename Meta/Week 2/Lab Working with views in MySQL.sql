...
#The table must include the following columns: Order ID, Quantity and Cost. Once you have executed 
#the query, select all data from the OrdersView table. 
...
#Task 2: Write a SQL statement that utilizes the ‘OrdersView’ virtual table to Update the base Orders table. In the UPDATE TABLE statement, 
#change the cost to 200 where the order id equals 2. Once you have executed the query, select all data from the OrdersView table.
