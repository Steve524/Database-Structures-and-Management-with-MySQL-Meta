...
#This emphasis the not null on the primary key so include it 
...
Create Table ContractInfo(ContractID INT NOT NULL PRIMARY KEY, 
StaffID INT NOT NULL,
Salary DECIMAL(7,2) NOT NULL,
Location VARCHAR(50) NOT NULL DEFAULT 'TEXAS',
StaffType VARCHAR(20) NOT NULL CHECK (StaffType = "Junior" OR "Senior")
