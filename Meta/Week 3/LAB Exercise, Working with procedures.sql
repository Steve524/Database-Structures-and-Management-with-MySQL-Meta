...
#Objective Create stored procedures with empty parameters. and Create stored procedures with two parameters.
...
#The procedure must contain two parameters that determine the range of retrieved data based on the user input of two cost values “MinimumValue” and “MaximumValue”.
