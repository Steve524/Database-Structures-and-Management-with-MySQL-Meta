...
#Objective Group data using the GROUP BY clause. and Filter grouped data using the HAVING clause.
...
Select OrderDate, count(OrderID) from Orders WHERE OrderDate Between '2022-06-01' AND '2022-06-30' Group by OrderDate;
#OR
