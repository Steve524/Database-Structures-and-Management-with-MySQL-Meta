...
Select employees.EmployeeName, employee_orders.Status From employees inner Join employee_orders on employees.EmployeeID = employee_orders.EmployeeID Having employee_orders.Status = "Completed";

#Select employees.EmployeeName from employees where employees.EmployeeName = ANY(Select employee_orders.Status From employee_orders where employee_orders.Status = "Completed" );
#Select EmployeeName from employees where EmployeeName = ANY(Select employee_orders.Status From employee_orders Having employee_orders.Status = "Completed" );
#Select All EmployeeName from employees Where employee_orders.Status = "Completed";
...
#ask 4: Use the HAVING clause to filter the grouped data in the subquery that you wrote in task 3 to filter the 20% OrderTotal 
